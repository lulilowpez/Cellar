...
namespace Cellar.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public IActionResult Autenticate(AuthDto auth) //Enviamos como parámetro la clase que creamos arriba
        {
            //Paso 1: Validamos las credenciales
            var user = _userService.ValidateUser(auth); //Lo primero que hacemos es llamar a una función que valide los parámetros que enviamos.
            ...
            var claimsForToken = new List<Claim>();
            {
                ...
                claimsForToken.Add(new Claim("role", ClaimTypes.Role, user.Rol.ToString()));
            }
